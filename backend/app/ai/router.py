...
async def analyze_page(
    ...
    prompt = (
        f"Analyse cette page pour la prospection :\nURL: {request.url}\n"
        f"Contenu extrait via Playwright:\n{text}\n\n"
        f"Donne moi 3 insights clés pour approcher ce prospect de manière hyper-personnalisée. "
        f"Formate la réponse en Markdown avec des tirets."
    )
